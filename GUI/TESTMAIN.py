...
Word.setStyleSheet("color: white;") 
...
sideLine.setStyleSheet("border: none; background-color: rgba(255, 253, 253, 0.3);")
...
Meaning.setStyleSheet("color: white;") 
...
Example.setStyleSheet("color: white;") 
...
Synonm.setStyleSheet("color: white;") 
...
Synonms.setStyleSheet("color: white;") 
